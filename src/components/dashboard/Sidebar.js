...
const SideBar = () => {
    return (
        <div className="relative w-1/5 flex flex-col bg-black text-white rounded-[30px] px-[50px] py-[60px]">
            ...
            <ul>
                <li className="flex mb-10 text-lg items-center font-bold cursor-pointer">
                    <DashboardIcon className="mr-4" />
                    Dashboard
                </li>
                <li className="flex mb-10 text-lg items-center 	font-normal	cursor-pointer">
            ...
            <ul className="absolute bottom-10">
                <li className="mb-5 font-normal	cursor-pointer">Help</li>
                <li className="mb-5 font-normal	cursor-pointer">Contact Us</li>
            </ul>
        </div>
    )
}
